INDONESIA_CITIES_AND_REGENCIES = [
    # Provinsi Aceh
    ...
    "Kabupaten Natuna", "Kota Batam", "Kota Tanjung Pinang",
    ...
    "Kabupaten Timor Tengah Selatan", "Kabupaten Timor Tengah Utara", "Kota Kupang",
    ...
    "Kabupaten Lamandau", "Kabupaten Murung Raya", "Kabupaten Pulang Pisau", "Kabupaten Seruyan", 
